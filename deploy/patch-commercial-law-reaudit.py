...
TEXT_REPLACEMENTS = [
    (
        "art8-current-general-scope",
        "非董事但實質執行董事業務或實質控制公司而指揮董事者，也可能負相應責任。",
        "公司法第 8 條第 3 項現行規定不限於公開發行公司：公司之非董事，而實質上執行董事業務，或實質控制公司之人事、財務或業務經營並實質指揮董事執行業務者，原則上與董事同負民事、刑事及行政罰之責任；但政府為法定公共利益目的對政府指派董事所為之指揮，有條文所定例外。",
    ),
    (
...
QUESTION_UPDATES = {
    "ch02-q05": {
        "question": "某人沒有董事名義，卻實質上執行董事業務，或實質控制公司人事、財務或業務經營並實質指揮董事執行業務，是否一定因沒有董事職稱而不負董事責任？",
        "answer": "不一定。",
        "explanation": "公司法第 8 條第 3 項現行規定並不限於公開發行股票之公司；符合實質執行董事業務，或實質控制公司人事、財務或業務經營並實質指揮董事執行業務等要件者，原則上與董事同負相應民事、刑事及行政責任，另有政府基於法定公共利益目的指揮其指派董事的例外。",
    },
    "ch07-q01": {
...
def main() -> None:
    ...
    forbidden = [
        "公司法第 8 條第 3 項只針對公開發行股票之公司",
        "第 8 條第 3 項只針對公開發行股票之公司",
