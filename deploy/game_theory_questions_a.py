...
{'id':'ch02-q04','chapterId':'ch02','question':'某策略只在對手的一種行動下比較差，其他情況反而比較好。能否稱它是嚴格劣勢策略？','answer':'不能。','explanation':'嚴格劣勢要求存在另一策略在所有對手策略下都嚴格更好。'},
{'id':'ch02-q05','chapterId':'ch02','question':'rationalizable strategy 是否必須本身出現在某個 Nash equilibrium 中？','answer':'不一定。','explanation':'合理化概念通常比 Nash 更寬；它保留可作為某些合理信念下最佳回應的策略。'},
...
{'id':'ch04-q02','chapterId':'ch04','question':'若 A 在均衡中以正機率混合 U 與 D，U 與 D 的期望報酬必須有何關係？','answer':'相同且都是最高期望報酬。','explanation':'支撐集內策略若有一個較差，玩家就不會對它給正機率。'},
...
{'id':'ch06-q05','chapterId':'ch06','question':'同質商品 Bertrand 模型得到 p=c 是否需要無容量限制等標準條件？','answer':'需要。','explanation':'產品差異、容量限制、離散價格或其他制度都可能使均衡價格高於邊際成本。'},

{'id':'ch07-q01','chapterId':'ch07','question':'向後歸納從賽局樹的哪一端開始？','answer':'從最後的決策節點開始。','explanation':'先求最末端玩家在各可能續局中的最佳行動，再逐層往前替換。'},
...
{'id':'ch07-q05','chapterId':'ch07','question':'「如果你進入我就打價格戰」若進入後 Fight 的報酬反而低於容納，這個威脅有何問題？','answer':'不可信。','explanation':'真的到達該節點時威脅者不願照做，因此需要 SPNE／向後歸納排除。'},
