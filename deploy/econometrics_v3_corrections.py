...
def build_v3(chapters, questions):
    ...
    # ch14: With heterogeneous treatment effects, a binary IV/Wald estimand is not
    # automatically the population ATE or ATT. State the standard complier/LATE scope.
    ...
    # ch15: Assignment-as-IV under noncompliance identifies a complier effect under
    # additional IV assumptions, not the effect for all people who actually took treatment.
    ...
    # ch16: Standard DiD also needs pre-treatment periods not to be contaminated by
    # treatment anticipation (or the anticipation window must be modeled explicitly).
    ...
    # ch17: Fuzzy RDD is an IV design local to the cutoff. Under heterogeneous effects,
    # the standard causal interpretation is a local complier LATE under additional assumptions.
    ...
    # ch18: Model selection must use validation/CV; the final test set should not be used
    # to choose between candidate models and then reused as an unbiased final evaluation.
