...
def main(root):
    ...
    ck(lib['version']=='2026.07.29-7','library version')
    ...
    # Lock the manually re-reviewed 100-question snapshot. This detects later drift;
    # mathematical and high-risk logic families are independently rechecked below.
    import hashlib
    ...
    # Independent quantitative / formal spot recomputation, covering each mathematical family.
    numeric={
    ...
    # Logic checks for high-risk distinctions.
    logic={
    ...
    print(f'MICRO_QA_OK round1={R1} round2={R2} questions=100 search=154 figures=20')
