...
def main(site_root:str,expected_library:str)->int:
 ...
 ids=[b['id'] for b in lib['books']]; ck(len(ids)>=13 and BOOK in ids,'industrial economics must remain in canonical library'); ck(ids.count(BOOK)==1,'single industrial economics registry entry')
