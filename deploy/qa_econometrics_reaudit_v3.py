...
def main(site_root: str, expected_library_version: str | None = None) -> None:
    ...
    # Structural and compatibility gates.
    ...
    # Preserve the prior v2 corrections.
    ...
    # Second independent content audit: IV/LATE scope.
    ...
    # Randomized experiment noncompliance: do not conflate IV LATE with ATT/TOT.
    ...
    # DiD: parallel trends is not the only timing requirement; clean pre periods matter.
    ...
    # Fuzzy RDD: local Wald interpretation is a cutoff complier LATE under assumptions.
    ...
    # Prediction: validation/CV performs selection; the final test set stays untouched.
    ...
    # Appendices must teach the same corrected decision rules.
    ...
    # Negative semantic gates against the specific overclaims found in this audit.
    ...
    # Independent quantitative rechecks. Each item recomputes from the stated inputs
    # and separately verifies that the displayed answer contains the recomputed result.
    numeric = [
