...
{'id':'ch11-q02','chapterId':'ch11','question':'進入例題中 Tough 機率0.4，遇 Tough 進入得-1、遇 Weak 得2。進入的期望報酬是多少？','answer':'0.8。','explanation':'0.4(-1)+0.6(2)=-0.4+1.2=0.8。'},
{'id':'ch11-q03','chapterId':'ch11','question':'同一例題若 Tough 機率改為0.8，進入的期望報酬是多少？','answer':'-0.4。','explanation':'0.8(-1)+0.2(2)=-0.8+0.4=-0.4，因此若 Out=0，會選 Out。'},
{'id':'ch11-q04','chapterId':'ch11','question':'BNE 的最佳回應是否要對每個可能型態分別檢查？','answer':'要。','explanation':'每個 type 在其可用資訊與信念下都必須沒有偏離誘因。'},
{'id':'ch11-q05','chapterId':'ch11','question':'Nature 抽出的 type 通常是玩家自己可自由選擇的策略嗎？','answer':'不是。','explanation':'type 通常代表由 Nature 決定的私人資訊；玩家選的是依 type 而定的 action/strategy。'},
...
{'id':'ch12-q03','chapterId':'ch12','question':'第二價拍賣「誠實出價是弱優勢」最典型依賴哪一類價值環境？','answer':'標準私人價值環境。','explanation':'若估值相互依賴或有共同價值，策略分析要額外處理資訊效果。'},
...
{'id':'ch12-q05','chapterId':'ch12','question':'revenue equivalence 是否不需要任何假設就成立？','answer':'不是。','explanation':'標準結果依賴對稱、獨立私人價值、風險中立、相同配置規則與邊界條件等。'},

{'id':'ch13-q01','chapterId':'ch13','question':'PBE 至少包含哪兩大類物件？','answer':'完整策略與信念。','explanation':'動態不完全資訊下，除了 strategy 還要明確寫各資訊集合的 belief。'},
...
{'id':'ch18-q05','chapterId':'ch18','question':'Nash equilibrium 與 social optimum 是否應視為同一個判斷？','answer':'不應。','explanation':'Nash 看個別偏離誘因；social optimum 依指定的社會目標函數比較總成本或總福利。'},
...
{'id':'ch19-q02','chapterId':'ch19','question':'動態、完整資訊且有真正子賽局時，哪個解概念能進一步排除不可信威脅？','answer':'SPNE。','explanation':'SPNE 要求每個子賽局都構成 Nash equilibrium。'},
...
{'id':'ch19-q05','chapterId':'ch19','question':'complete information 與 perfect information 是否同義？','answer':'不是。','explanation':'完整資訊著重賽局結構／報酬相關資訊是否已知；完美資訊更強，要求每次行動時知道此前所有實際行動。'}
]
