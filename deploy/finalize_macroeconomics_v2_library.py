...
def main(site_root, expected_before):
 ...
 # -> money & banking v2 -> computer fundamentals v1 -> mathematical economics v1.
 ...
 from integrate_mathematical_economics import integrate as integrate_mathematical_economics
 ...
 final_version=integrate_mathematical_economics(site_root,computer_version)
 print(final_version)
