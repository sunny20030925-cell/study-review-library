...
- 正式書籍數：20 本。
- 最新正式 Pages run：`30493853637`。
- 最新正式部署 source commit：`d6a83769482eb2fcfc9fcf93a08aa037b4abdddd`。
- 最新 Pages artifact：`8740798612`。
- Artifact digest：`sha256:c863a5421710c55696d1b62492d4dfb2d8ed2ecc2f15b37137efd03e1f9e7f94`。
- Pages 狀態：正式 artifact 上傳、Pages deployment 與下載後 artifact recheck 均成功；`2026-07-29T21:50:23.937635+00:00`。
...
- 正式 Pages run：`30493853637`；Source commit：`d6a83769482eb2fcfc9fcf93a08aa037b4abdddd`；artifact：`8740798612`。
- Artifact digest／下載 SHA-256：`sha256:c863a5421710c55696d1b62492d4dfb2d8ed2ecc2f15b37137efd03e1f9e7f94`。
...
- 正式 Pages run：`30493853637`；Source commit：`d6a83769482eb2fcfc9fcf93a08aa037b4abdddd`。
- 狀態：已部署。
...
7. 最新正式書庫：20 本，`2026.07.30-8`；Pages run `30493853637`，artifact `8740798612`。
