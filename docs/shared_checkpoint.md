...
- 正式書庫內容版本：`2026.07.30-5`
- 正式書籍數：20 本。
- 最新正式 Pages run：`30489962137`。
- 最新正式部署 source commit：`e31e3b79327ca38986e4d1a2cdf517c69c3df06d`。
- 最新 Pages artifact：`8739266866`。
- Artifact digest：`sha256:f79df76813ac8ccfc28f8aa910919f5e4fc98e42bd649aa797b5ddba925679c5`。
- Pages 狀態：正式 artifact 上傳、Pages deployment 與下載後 artifact recheck 均成功；`2026-07-29T20:50:04.212876+00:00`。
- 部署回條：`docs/deployment_receipt.json`；`status=success`、`book_count=20`、`library_version=2026.07.30-5`、`progress_storage_changed=false`。
...
- 正式 Pages run：`30489962137`；Source commit：`e31e3b79327ca38986e4d1a2cdf517c69c3df06d`；artifact：`8739266866`。
- Artifact digest／下載 SHA-256：`sha256:f79df76813ac8ccfc28f8aa910919f5e4fc98e42bd649aa797b5ddba925679c5`。
...
- 正式 Pages run：`30489962137`；Source commit：`e31e3b79327ca38986e4d1a2cdf517c69c3df06d`。
- 狀態：已部署。
...
7. 最新正式書庫：20 本，`2026.07.30-5`；Pages run `30489962137`，artifact `8739266866`。
