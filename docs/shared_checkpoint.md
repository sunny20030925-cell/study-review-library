...
- 正式書籍數：20 本。
- 最新正式 Pages run：`30490932468`。
- 最新正式部署 source commit：`3b5d3f894432810299bc30fc86fd741d3feb6ff8`。
- 最新 Pages artifact：`8739640949`。
- Artifact digest：`sha256:dfefd00509f0b661dc03bfc09bb98262ea762bab096769c7356256f09182d150`。
- Pages 狀態：正式 artifact 上傳、Pages deployment 與下載後 artifact recheck 均成功；`2026-07-29T21:04:48.387505+00:00`。
...
- 正式 Pages run：`30490932468`；Source commit：`3b5d3f894432810299bc30fc86fd741d3feb6ff8`；artifact：`8739640949`。
- Artifact digest／下載 SHA-256：`sha256:dfefd00509f0b661dc03bfc09bb98262ea762bab096769c7356256f09182d150`。
...
- 正式 Pages run：`30490932468`；Source commit：`3b5d3f894432810299bc30fc86fd741d3feb6ff8`。
- 狀態：已部署。
...
7. 最新正式書庫：20 本，`2026.07.30-8`；Pages run `30490932468`，artifact `8739640949`。
